...
func TestBackupCommand(t *testing.T) {
	...
	// test xtrabackup commands
	{
		...
		want := []string{
			"-c",
			"./innobackupex --defaults-file=/etc/my3306.cnf --host=localhost --user=root --throttle=100 --parallel=2 --stream=xbstream ./ | ssh -o 'StrictHostKeyChecking=no' user@127.0.0.1 -p 22 \"/u01/xtrabackup_20161216/xbstream -x -C /u01/backup\"",
		}
		...
		want = []string{
			"-c",
			"./innobackupex --defaults-file=/etc/my3306.cnf --host=localhost --user=root --throttle=100 --parallel=2 --stream=xbstream ./ | sshpass -p sshpasswd ssh -o 'StrictHostKeyChecking=no' user@127.0.0.1 -p 22 \"/u01/xtrabackup_20161216/xbstream -x -C /u01/backup\"",
		}
		assert.Equal(t, want, got)
	}
	...
	// test with innodbbackup password
	{
		...
		want := []string{
			"-c",
			"./innobackupex --defaults-file=/etc/my3306.cnf --host=localhost --user=root --password=123 --throttle=100 --parallel=2 --stream=xbstream ./ | ssh -o 'StrictHostKeyChecking=no' user@127.0.0.1 -p 22 \"/u01/xtrabackup_20161216/xbstream -x -C /u01/backup\"",
		}
		assert.Equal(t, want, got)
		...
		want = []string{
			"-c",
			"./innobackupex --defaults-file=/etc/my3306.cnf --host=localhost --user=root --password=123 --throttle=100 --parallel=2 --stream=xbstream ./ | sshpass -p sshpasswd ssh -o 'StrictHostKeyChecking=no' user@127.0.0.1 -p 22 \"/u01/xtrabackup_20161216/xbstream -x -C /u01/backup\"",
		}
		assert.Equal(t, want, got)
